...
// The behavioral contract suite for this class lives in
// @boardgamesempire/plugin-contract-testing and is exercised there against
// the same fixture; this spec covers only what the suite deliberately
// leaves to the base class — error metadata.
